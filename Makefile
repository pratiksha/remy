source = link.cc receiver.cc window-tester.cc random.cc window-sender.cc sendergang.cc rat.cc remy.cc window-sender-templates.cc rat-templates.cc link-templates.cc network.cc emil-tester.cc emil.cc emil-templates.cc whisker.cc memory.cc memoryrange.cc evaluator.cc dna.pb.cc ratbreeder.cc rat-runner.cc rat-printer.cc global-settings.cc
...
CXX = g++
LANGFLAGS = -std=c++0x
CXXFLAGS = -g -O2 $(LANGFLAGS) -pedantic -Werror -Wall -Wextra -Weffc++ -fno-default-inline -pipe -pthread
...
batch-runner: rat-runner.o $(objects)
	$(CXX) $(CXXFLAGS) -o $@ $+ $(LIBS)
