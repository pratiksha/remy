...
int main( int argc, char *argv[] )
{
  ...
  configuration_range.link_packets_per_ms = make_pair( .1, 10 ); /* 10 Mbps to 20 Mbps */
  configuration_range.rtt_ms = make_pair( 10, 1000 ); /* ms */
  configuration_range.max_senders = 8;
