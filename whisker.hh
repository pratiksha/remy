...
static constexpr double MAX_INTERSEND = 40;
static constexpr double MAX_MULTIPLE = 2.0;

static const unsigned int MAX_WINDOW_INCR = 10;
static constexpr double MAX_INTERSEND_INCR = 10;
...
static constexpr double MIN_INTERSEND = 5;
static constexpr double MULTIPLE_INCR = 0.1;

static constexpr double INTERSEND_INCR = 1;
#endif
